...
char** tokenize(char* s){
    ...
    for(int i = 0; i < tokensNum; i++){
        tokens[i] = copy_str(start, sizeof(s));  //in each iteration copies the string and send it to tokens 
